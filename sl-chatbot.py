...
if prompt:
    ...
    # Add user message to chat history
    st.session_state.messages.append({"role": "user", "content": prompt})
    URL = 'https://snapgpt.labs.snaplogicdev.com/api/1/rest/slsched/feed/snaplogic/Kadday/LLM_Playground/loopio_bot_task'
    BEARER_TOKEN ='J72ExNISjgSeUPvcjgHhfm6bhh0zNao6'
    data = {"prompt" : prompt}
    headers = {
    ...
    BEARER_TOKEN ='bMi7YwHvGgNF4DFmYtaR3vF5RYD2arwl'
    data = {"prompt" : prompt}
    headers = {
        'Authorization': f'Bearer {BEARER_TOKEN}'
    }
